...
This setup mirrors the one of [Integrated Dynamics](https://github.com/CyclopsMC/IntegratedDynamics/blob/master-26-lts/PERFORMANCE_BENCHMARKING.md),
...
4. Add a test environment definition for that environment name in
   `src/main/resources/data/integratedtunnels/test_environment/`
5. The workflow will automatically execute and track the new benchmark

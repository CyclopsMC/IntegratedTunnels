...
public class Achievements {
    ...
    public static final Achievement INTERFACE_ITEM   = new ExtendedAchievement("interface_item",   1, -1, new ItemStack(PartTypes.INTERFACE_ITEM.getItem()),   null);
    public static final Achievement INTERFACE_FLUID  = new ExtendedAchievement("interface_fluid",  1, -2, new ItemStack(PartTypes.INTERFACE_FLUID.getItem()),  null);
    public static final Achievement INTERFACE_ENERGY = new ExtendedAchievement("interface_energy", 1, -3, new ItemStack(PartTypes.INTERFACE_ENERGY.getItem()), null);

    public static final Achievement EXPORTER_ITEM = new ExtendedAchievement("exporter_item", 2, -1, new ItemStack(PartTypes.EXPORTER_ITEM.getItem()), null);
    public static final Achievement IMPORTER_ITEM = new ExtendedAchievement("importer_item", 2, -2, new ItemStack(PartTypes.IMPORTER_ITEM.getItem()), null);

    public static final Achievement IMPORT_ALL_ITEMS = new ExtendedAchievement("import_all_items", 3, -1, makeAspectItemStack(TunnelAspects.Write.Item.BOOLEAN_IMPORT), null);

    public static final Achievement EXPORT_ITEMS_LIMIT = new ExtendedAchievement("export_items_limit", 3, -2, makeAspectItemStack(TunnelAspects.Write.Item.ITEMSTACK_EXPORT), null);

    public static final Achievement IMPORT_ITEMS_LIST = new ExtendedAchievement("import_items_list", 3, -3, makeAspectItemStack(TunnelAspects.Write.Item.LIST_IMPORT), null);

    public static final Achievement EXPORT_ENCHANTABLE_ITEMS = new ExtendedAchievement("export_enchantable_items", 3, -4, makeAspectItemStack(TunnelAspects.Write.Item.PREDICATE_EXPORT), null);

...
public class GameTestsPerformance {
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_interfaces_item_idle")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_interfaces_fluid_idle")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_interfaces_energy_idle")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_interfaces_item_idle_deep")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_items_transfer")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_fluids_transfer")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_energy_transfer")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_items_transfer_predicate")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_items_filtering_interfaces")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_items_index_query")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_interfaces_item_append")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_interfaces_item_remove")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_world_block_churn")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_world_entityitem_churn")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT_TICKS, environment = Reference.MOD_ID + ":performance_player_simulator")

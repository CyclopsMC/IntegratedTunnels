...
public class GameTestsWorldBlock {
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT, environment = "integratedtunnels:config_blockimporterblacklist_1")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT, environment = "integratedtunnels:config_blockimporterblacklist_2")
    ...
    @GameTest(template = TEMPLATE_EMPTY, timeoutTicks = TIMEOUT, environment = "integratedtunnels:config_blockimporterblacklist_3")
    ...
    public void testWorldBlockImporterMatchBlockBlockCorrect(GameTestHelper helper) {
        ...
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_BLOCK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.OBJECT_BLOCK, ValueObjectTypeBlock.ValueBlock.of(Blocks.STONE.defaultBlockState())));
    ...
    public void testWorldBlockImporterMatchBlockBlockIncorrect(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_BLOCK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.OBJECT_BLOCK, ValueObjectTypeBlock.ValueBlock.of(Blocks.COBBLESTONE.defaultBlockState())));
        setMatchBlock(importer, TunnelAspects.Write.World.BLOCK_BLOCK_IMPORT, true);
    ...
    public void testWorldBlockImporterMatchBlockItemStackCorrect(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_ITEMSTACK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.OBJECT_ITEMSTACK, ValueObjectTypeItemStack.ValueItemStack.of(new ItemStack(Blocks.STONE))));
    ...
    public void testWorldBlockImporterMatchBlockItemStackIncorrect(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_ITEMSTACK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.OBJECT_ITEMSTACK, ValueObjectTypeItemStack.ValueItemStack.of(new ItemStack(Blocks.COBBLESTONE))));
        setMatchBlock(importer, TunnelAspects.Write.World.BLOCK_ITEMSTACK_IMPORT, true);
    ...
    public void testWorldBlockImporterMatchBlockListCorrect(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_LISTBLOCK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.LIST, ValueTypeList.ValueList.ofAll(
    ...
    public void testWorldBlockImporterMatchBlockBoolean(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_BOOLEAN_IMPORT, new ItemStack(RegistryEntries.ITEM_VARIABLE));
    ...
    public void testWorldBlockImporterMatchBlockWithoutItemDrops(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_BLOCK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.OBJECT_BLOCK, ValueObjectTypeBlock.ValueBlock.of(Blocks.COAL_ORE.defaultBlockState())));
        setMatchBlock(importer, TunnelAspects.Write.World.BLOCK_BLOCK_IMPORT, true);
    ...
    public void testWorldBlockImporterMatchBlockPredicate(GameTestHelper helper) {
        ...
        PartPos importer = PartPos.of(helper.getLevel(), helper.absolutePos(POS), Direction.WEST);
        placeVariableInWriter(helper, helper.getLevel(), importer, TunnelAspects.Write.World.BLOCK_PREDICATEBLOCK_IMPORT, createVariableForValue(helper.getLevel(), ValueTypes.OPERATOR, ValueTypeOperator.ValueOperator.of(Operators.OBJECT_BLOCK_OPAQUE)));

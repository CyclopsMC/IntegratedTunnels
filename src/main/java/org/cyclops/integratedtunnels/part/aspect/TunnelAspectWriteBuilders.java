...
public class TunnelAspectWriteBuilders {
    ...
    public static <T, M> IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<T, M>>, Void> propSetFilter() {
        return input -> {
            ...
            if (partStateHolder != null) {
                ...
                PartTypeInterfacePositionedAddonFiltering partType = ((PartTypeInterfacePositionedAddonFiltering<?, T, ?, ?>) partStateHolder.getPart());
                PartTypeInterfacePositionedAddonFiltering.State<?, T, ?, ?> partState = partStateHolder.getState();
                PartTarget target = input.getLeft();

                partState.setTargetFilter(new PositionedAddonsNetworkIngredientsFilter<>(
                        input.getRight().getIngredientPredicate(),
                        properties.getValue(PROP_FILTER_APPLY_TO_INSERTIONS).getRawValue(),
    ...
    public static final IAspectPropertyTypeInstance<ValueTypeBoolean, ValueTypeBoolean.ValueBoolean> PROP_FILTER_APPLY_TO_EXTRACTIONS =
            new AspectPropertyTypeInstance<>(ValueTypes.BOOLEAN, "aspect.aspecttypes.integratedtunnels.boolean.filter.applytoextract");
    public static final IAspectPropertyTypeInstance<ValueTypeBoolean, ValueTypeBoolean.ValueBoolean> PROP_FILTER_ALLOW_ALL_IF_NOT_APPLIED =
            new AspectPropertyTypeInstance<>(ValueTypes.BOOLEAN, "aspect.aspecttypes.integratedtunnels.boolean.filter.allowallifnotapplied");
    ...
    public static final IAspectWriteDeactivator RESET_FILTER = new IAspectWriteDeactivator() {
        ...
        public <P extends IPartTypeWriter<P, S>, S extends IPartStateWriter<P>> void onDeactivate(P partType, PartTarget target, S state) {
            if (state instanceof PartTypeInterfacePositionedAddonFiltering.State) {
                ...
                partTypeCast.removePositionFromNetwork(
                        stateCast.getNetwork(),
                        target.getTarget(),
                        stateCast
                );
    ...
    public static final class Energy {
        ...
        public static final AspectBuilder<ValueTypeBoolean.ValueBoolean, ValueTypeBoolean, Triple<PartTarget, IAspectProperties, Boolean>>
                BUILDER_BOOLEAN = AspectWriteBuilders.BUILDER_BOOLEAN.byMod(Reference.MOD_ID)
        ...
        public static final AspectBuilder<ValueTypeLong.ValueLong, ValueTypeLong, Triple<PartTarget, IAspectProperties, Long>>
                BUILDER_LONG = TunnelAspectWriteBuilders.BUILDER_LONG.byMod(Reference.MOD_ID)
                .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR)
        ...
        static {
            ...
            PROPERTIES_RATE.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_RATECRAFT.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Boolean>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<Long, Boolean>>>
            ...
            return Triple.of(input.getLeft(), input.getMiddle(), ChanneledTargetInformation.of(energyMatcher, energyMatcher, -1));
        };
    ...
    public static final class Item {
        ...
        public static final AspectBuilder<ValueTypeInteger.ValueInteger, ValueTypeInteger, Triple<PartTarget, IAspectProperties, Integer>>
                BUILDER_INTEGER = AspectWriteBuilders.BUILDER_INTEGER.byMod(Reference.MOD_ID)
                .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR)
        ...
        public static final AspectBuilder<ValueTypeList.ValueList, ValueTypeList, Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>>
                BUILDER_LIST = AspectWriteBuilders.BUILDER_LIST.byMod(Reference.MOD_ID)
                .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR)
        ...
        public static final AspectBuilder<ValueTypeOperator.ValueOperator, ValueTypeOperator, Triple<PartTarget, IAspectProperties, ValueTypeOperator.ValueOperator>>
                BUILDER_OPERATOR = AspectWriteBuilders.BUILDER_OPERATOR.byMod(Reference.MOD_ID)
                .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR)
                .appendKind("item").withProperties(PROPERTIES_CHANNEL);
        public static final AspectBuilder<ValueTypeNbt.ValueNbt, ValueTypeNbt, Triple<PartTarget, IAspectProperties, Optional<Tag>>>
                BUILDER_NBT = AspectWriteBuilders.BUILDER_NBT.byMod(Reference.MOD_ID)
                .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR)
        ...
        public static final IAspectPropertyTypeInstance<ValueTypeBoolean, ValueTypeBoolean.ValueBoolean> PROP_PREDICATE_SLOTBASED =
                new AspectPropertyTypeInstance<>(ValueTypes.BOOLEAN, "aspect.aspecttypes.integratedtunnels.boolean.item.predicateslotbased");
        ...
        public static final IAspectProperties PROPERTIES_FILTER_NBT = new AspectProperties(ImmutableList.<IAspectPropertyTypeInstance>of(
                PROP_FILTER_APPLY_TO_INSERTIONS,
                PROP_FILTER_APPLY_TO_EXTRACTIONS,
                PROP_FILTER_ALLOW_ALL_IF_NOT_APPLIED,
                PROP_BLACKLIST,
        ...
        static {
            ...
            PROPERTIES_RATESLOT.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_SLOT.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_RATESLOTCHECKS.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_RATESLOTCHECKSCRAFT.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_RATESLOTCHECKSLIST.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_NBT.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_FILTER_CHECKS.setValue(PROP_FILTER_ALLOW_ALL_IF_NOT_APPLIED, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_FILTER_NBT.setValue(PROP_FILTER_ALLOW_ALL_IF_NOT_APPLIED, ValueTypeBoolean.ValueBoolean.of(false));
        ...
        public static final IAspectValuePropagator<IItemTarget, Void>
            ...
            if (input.hasValidTarget()) {
                ...
                IIngredientComponentStorage<ItemStack, Integer> source = input.getItemStackMatcher().hasMatchFlags() || !input.getProperties().getValue(TunnelAspectWriteBuilders.Item.PROP_PREDICATE_SLOTBASED).getRawValue() ? input.getItemChannel() : input.getItemChannelSlotted();
    ...
    public static final class Fluid {
        ...
        public static final IAspectPropertyTypeInstance<ValueTypeBoolean, ValueTypeBoolean.ValueBoolean> PROP_PREDICATE_SLOTBASED =
                new AspectPropertyTypeInstance<>(ValueTypes.BOOLEAN, "aspect.aspecttypes.integratedtunnels.boolean.fluid.predicateslotbased");
        ...
        static {
            ...
            PROPERTIES_RATECHECKS.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_RATECHECKSCRAFT.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            PROPERTIES_RATECHECKSLIST.setValue(PROP_PASSIVE_IO, ValueTypeBoolean.ValueBoolean.of(false));
        ...
        public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, Boolean>, Triple<PartTarget, IAspectProperties, ChanneledTargetInformation<FluidStack, Integer>>>
            ...
            return Triple.of(input.getLeft(), input.getMiddle(), ChanneledTargetInformation.of(fluidMatcher, fluidMatcher, -1));
        };
    ...
    public static final class World {
        ...
        public static final AspectBuilder<ValueObjectTypeBlock.ValueBlock, ValueObjectTypeBlock, Triple<PartTarget, IAspectProperties, BlockState>>
                BUILDER_BLOCK = BUILDER_BLOCK_BASE.byMod(Reference.MOD_ID)
        ...
        public static final class Item {
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PLACE_NOCHECKSPREDICATE = PROPERTIES_ENTITYITEM_PLACE_NORATE_NOCHECKS.clone();
            ...
            public static final IAspectProperties PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE = new AspectProperties(ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    //PROP_EXACTAMOUNT,
                    PROP_IGNORE_PICK_UP_DELAY,
            ...
            static {
                ...
                PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE.setValue(PROP_CHANNEL, ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE.setValue(PROP_ROUNDROBIN, ValueTypeBoolean.ValueBoolean.of(false));
                //PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE.setValue(PROP_EXACTAMOUNT, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE.setValue(PROP_IGNORE_PICK_UP_DELAY, ValueTypeBoolean.ValueBoolean.of(true));
                PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE.setValue(TunnelAspectWriteBuilders.Item.PROP_RATE, ValueTypeInteger.ValueInteger.of(64));
                PROPERTIES_ENTITYITEM_PICK_UP_NOCHECKSPREDICATE.setValue(TunnelAspectWriteBuilders.Item.PROP_PREDICATE_SLOTBASED, ValueTypeBoolean.ValueBoolean.of(false));
                ...
                PROPERTIES_ENTITYITEM_PLACE_NOCHECKSPREDICATE.setValue(TunnelAspectWriteBuilders.Item.PROP_RATE, ValueTypeInteger.ValueInteger.of(64));
                PROPERTIES_ENTITYITEM_PLACE_NOCHECKSPREDICATE.setValue(TunnelAspectWriteBuilders.Item.PROP_PREDICATE_SLOTBASED, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            public static final IAspectProperties PROPERTIES_RATESLOTPREDICATE = TunnelAspectWriteBuilders.Item.PROPERTIES_RATESLOTPREDICATE.clone();
            public static final IAspectProperties PROPERTIES_SLOT = TunnelAspectWriteBuilders.Item.PROPERTIES_SLOT.clone();
            public static final IAspectProperties PROPERTIES_RATE = TunnelAspectWriteBuilders.Item.PROPERTIES_RATE.clone();
            ...
            public static final IAspectProperties PROPERTIES_RATESLOTCHECKSPREDICATE = TunnelAspectWriteBuilders.Item.PROPERTIES_RATESLOTCHECKS.clone();
        ...
        public static final class Fluid {
            ...
            public static final IAspectProperties PROPERTIES_CHANNELPREDICATE = new AspectProperties(ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
            ...
            public static final IAspectProperties PROPERTIES_UPDATEPREDICATE = new AspectProperties(ImmutableList.<IAspectPropertyTypeInstance>of(
                    PROP_CHANNEL,
                    PROP_ROUNDROBIN,
                    PROP_BLOCK_UPDATE,
                    PROP_IGNORE_REPLACABLE,
            ...
            public static final IAspectProperties PROPERTIES_RATEPREDICATE = TunnelAspectWriteBuilders.Fluid.PROPERTIES_RATE.clone();
            ...
            static {
                PROPERTIES_CHANNEL.setValue(PROP_CHANNEL, ValueTypeInteger.ValueInteger.of(IPositionedAddonsNetworkIngredients.DEFAULT_CHANNEL));
                PROPERTIES_CHANNEL.setValue(PROP_ROUNDROBIN, ValueTypeBoolean.ValueBoolean.of(false));
                PROPERTIES_CHANNELPREDICATE.setValue(TunnelAspectWriteBuilders.Fluid.PROP_PREDICATE_SLOTBASED, ValueTypeBoolean.ValueBoolean.of(false));
            ...
            public static final IAspectValuePropagator<Triple<PartTarget, IAspectProperties, ValueTypeList.ValueList>, IFluidTarget>
                ...
                boolean checkNbt = properties.getValue(TunnelAspectWriteBuilders.Fluid.PROP_CHECK_NBT).getRawValue();
                boolean blacklist = properties.getValue(PROP_BLACKLIST).getRawValue();
                IngredientPredicate<FluidStack, Integer> fluidStackPredicate = TunnelFluidHelpers.matchFluidStacks(list.getRawValue(), true, false, checkNbt, blacklist, IModHelpersNeoForge.get().getFluidHelpers().getBucketVolume(), true);
                return IFluidTarget.ofBlock(fluidStackPredicate, input.getLeft(), input.getMiddle(), fluidStackPredicate);
            };
